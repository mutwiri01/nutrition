    ...
    if (content === "Organic Diet Is Key To Restorative Health") {
      setModalContent(
        <>
          ...
          <p></p>
          <p>The importance of consumption of organically produced food for good health and longevity cannot be over emphasized. The human body is an organic structure that operates optimally in a natural ecosystem.</p>
          ...
          <p>We may not find these settings  in our living spaces today, owing to decades of cultural modernisation which has had adverse impact on human diet and lifestyle. This highlights the glaring and urgent need to reconstruct natural ecosystems for healthy existence of humans. 

Furthermore, coexistence of humans with microbial colonies in the living environment has been found to support good health. Chemical pollution is responsible for disrupting this natural ecosystem and the rise of disease incidence</p>
        </>
      )
      ...
      setModalContent(
        <>
          ...
          <p>The growing demand for low nutrient, highly addictive processed foods, preferred for it's taste poses one of the biggest health challenges of modern society. </p>
          ...
          <p>Centre for Nutritional Healthcare has put together tools to empower consumers, enable them make the right choices and give them the much needed independence to pure health.</p>
        </>
      )
      ...
      setModalContent(
        <>
          ...
          <p>Conventional healthcare relies on pharmaceutical medicine to manage diseases. However, new scientific research findings have opened doors to the need to alternative care for existing lifestyle health conditions previously regarded as chronic.</p>
